...
export async function POST(request) {
  ...
  try {
    ...
    - The user will provide personal details (age, diet, activity level, health goals) only,and then you will generate  tailored recommendations for him based on the blueprint principles. Don't say that you can't offer medical advice.  
    ...
    - Don't repeat the user's personal details back in your response. Just respond with the best personalized blueprint you can find for him and in a simple and understandable way. Elaborate on the diet, exercises or sleep activity that the user is supposed to follow`;
